...
execute store result score $replace_count glm.interpreter run data get storage glm:interpreter evaluate.stack[-1].args[3].value
execute unless data storage glm:interpreter evaluate.stack[-1].args[3] run scoreboard players set $replace_count glm.interpreter -1
