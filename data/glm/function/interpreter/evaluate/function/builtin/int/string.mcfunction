data modify storage glm:utils/string/from_array target set from storage glm:api/interpreter/function execute.args[0].value
...
function glm:interpreter/evaluate/function/builtin/int/string_macro with storage glm:utils/string/from_array
