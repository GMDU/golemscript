...
execute unless data storage glm:parser stack[-1].metadata.close{type:"end"} run data modify storage glm:parser raise set value "Unexpected 'end' keyword in block."