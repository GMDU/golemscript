...
data modify storage moxlib:api/data/array/slice target set from storage glm:interpreter evaluate.stack[-1].args[0].value
data modify storage moxlib:api/data/array/slice start set from storage glm:interpreter evaluate.stack[-1].args[1].value

execute if data storage glm:interpreter evaluate.stack[-1].args[2] run function glm:interpreter/evaluate/function/builtin/slice/end
