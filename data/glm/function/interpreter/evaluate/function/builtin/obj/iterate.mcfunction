...
execute unless data storage glm:interpreter temp.args.current.value[] run data modify storage glm:interpreter error set value "RuntimeError: Function obj() cannot transform an empty array."
execute unless data storage glm:interpreter temp.args.current{variant:"array"} run data modify storage glm:interpreter error set value "RuntimeError: Function obj() expected an array of only type 'array'."
execute unless data storage glm:interpreter temp.args.key.value[] run data modify storage glm:interpreter error set value "RuntimeError: Cannot set blank string as object key."
execute unless data storage glm:interpreter temp.args.key{variant:"string"} run data modify storage glm:interpreter error set value "RuntimeError: Cannot set non string type as object key."
